...
CustomPlotWindow::CustomPlotWindow(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::CustomPlotWindow)
{
    ui->setupUi(this);
...
CustomPlotWindow::~CustomPlotWindow()
{
    delete ui;
}

void CustomPlotWindow::setupDemo(int demoIndex)
{
  switch (demoIndex)
  {
...
void CustomPlotWindow::drawCurve(QString name, QStringList& time, QList<double>* value)
{
  strTime = time;
  int cnt= value->count();
  ...
  ui->customPlot->yAxis->setRange(min-(max-min)*0.1, max+(max-min)*0.1);
...
void CustomPlotWindow::myMouseMove(QMouseEvent* e)
{
    ...
    QString hint;
    int i=qRound(x_val);
    if(i>=0 && i<strTime.count())
    {
        hint = QString("( x = %1  y = %2 ) \n      %3").arg(x_val).arg(y_val).arg(strTime.at(i));
        ui->customPlot->setToolTip(hint);
    }
}

void CustomPlotWindow::drawRealtimeCurve(QString name, int i, QStringList* valueList)
{
  itemNum=i;
...
void CustomPlotWindow::setupSimpleDemo(QCustomPlot *customPlot)
{
...
void CustomPlotWindow::setupSincScatterDemo(QCustomPlot *customPlot)
{
...
void CustomPlotWindow::setupScatterStyleDemo(QCustomPlot *customPlot)
{
...
void CustomPlotWindow::setupLineStyleDemo(QCustomPlot *customPlot)
{
...
void CustomPlotWindow::setupScatterPixmapDemo(QCustomPlot *customPlot)
{
...
void CustomPlotWindow::setupDateDemo(QCustomPlot *customPlot)
{
  demoName = "Date Demo";
...
void CustomPlotWindow::setupTextureBrushDemo(QCustomPlot *customPlot)
{
...
void CustomPlotWindow::setupMultiAxisDemo(QCustomPlot *customPlot)
{
...
void CustomPlotWindow::setupLogarithmicDemo(QCustomPlot *customPlot)
{
...
void CustomPlotWindow::setupRealtimeDataDemo(QCustomPlot *customPlot)
{
...
void CustomPlotWindow::setupParametricCurveDemo(QCustomPlot *customPlot)
{
...
void CustomPlotWindow::setupBarChartDemo(QCustomPlot *customPlot)
{
...
void CustomPlotWindow::setupStatisticalDemo(QCustomPlot *customPlot)
{
...
void CustomPlotWindow::setupSimpleItemDemo(QCustomPlot *customPlot)
{
...
void CustomPlotWindow::setupItemDemo(QCustomPlot *customPlot)
{
  demoName = "Item Demo";
...
void CustomPlotWindow::setupStyledDemo(QCustomPlot *customPlot)
{
...
void CustomPlotWindow::setupAdvancedAxesDemo(QCustomPlot *customPlot)
{
...
void CustomPlotWindow::setupColorMapDemo(QCustomPlot *customPlot)
{
...
void CustomPlotWindow::setupFinancialDemo(QCustomPlot *customPlot)
{
...
void CustomPlotWindow::setupPlayground(QCustomPlot *customPlot)
{
  Q_UNUSED(customPlot)
}

void CustomPlotWindow::screenShot()
{
...
void CustomPlotWindow::allScreenShots()
{
#if QT_VERSION < QT_VERSION_CHECK(5, 0, 0)
  QPixmap pm = QPixmap::grabWindow(qApp->desktop()->winId(), this->x()+2, this->y()+2, this->frameGeometry().width()-4, this->frameGeometry().height()-4);
#else
